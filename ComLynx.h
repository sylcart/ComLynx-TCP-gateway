...
#define ComLynx_h
/*
    Name: COMLynx (RS485) class definition    
*/
...
class ComLynx {
  ...
  private:
    String  RX_INV(int RX_LENGTH);
    void    TX_INV(const String InvAddr, String TXLocal);
    int     HexToDec(String hexString);
    String  DecToHex(uint8_t decValue);
    String  OutStuffing(String *ChrStrStuff);
    char    nibble_to_hex(uint8_t nibble);
    int pppfcs16(byte* pByte, int length);
    String fcsout(byte* pByte, int length);
    unsigned int ChrHex2Asc(String *ChrString);
    ...
    String PreGet             = "0A01C8";     // Size of data field + Message Type + Document number
    String PostGet            = "8000000000";
    const String CAN_Reply_ok = "0A81C80D";   // a valid CAN message contains always this string.
    String GetAddr            = "0015";       // Ping Size 0x00,Type 0x15 
    String TXData ;
    String GetMsg             = "1D13";       // Get node information size and Type
